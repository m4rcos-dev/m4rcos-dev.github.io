...
class CardProjects extends Component {
  ...
  handleToggle = ({ target }) => {
    ...
    const fullArray =
      video !== "" ? [...allImagesProject, video] : [...allImagesProject];
  ...
  render() {
    ...
    const { open, currentImage, currentLengthImage, arrayMedia, currrentAlt } =
      this.state;
    ...
    const currentTypographyTitleSize =
      currentScreen.width <= values.md2 ? "h5" : "h4";
    const currentIconTitleSize =
      currentScreen.width <= values.md2 ? "medium" : "large";
    ...
    return dataProjects(colorChange, currentIconTitleSize).map((dataVanila) => (
      <Box
        key={uuidv4()}
        sx={{
          width: "100%",
                ...
                >
                  ...
                  currentImage === currentLengthImage - 1 ? (
                    <iframe
                      width="1143"
                      height="644.469"
                      src={arrayMedia[currentLengthImage - 1]}
              ...
              >
                {(() => {
                  const LinkButton = (
                    <Link
                      href={
                        dataVanilabody.linkGitHub === "private"
                          ? undefined
                          : dataVanilabody.linkGitHub
                      }
                      target="_blank"
                      sx={{
                        widht: "100%",
                    ...
                    >
                      <Button
                        variant="contained"
                        disabled={dataVanilabody.linkGitHub === "private"}
                        sx={{
                          width: "100%",
                  ...
                  return dataVanilabody.linkGitHub === "private" ? (
                    <Tooltip title="Repositorio Privado">{LinkButton}</Tooltip>
                  ) : (
                    LinkButton
                  );
                })()}
